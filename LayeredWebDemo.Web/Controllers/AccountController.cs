...
namespace LayeredWebDemo.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            return View(new RegisterViewModel() { DateOfBitrh = DateTime.Now });
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userService.PasswordSignInAsync(model.Email, model.Password);
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            var result = await _userService.ExternalSignInAsync(loginInfo, isPersistent: false);
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(returnUrl);
